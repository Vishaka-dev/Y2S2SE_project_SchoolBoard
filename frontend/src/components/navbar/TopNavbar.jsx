...
const TopNavbar = () => {
  ...
  const getNavButtonClass = (isActive) =>
    `relative p-2.5 rounded-xl transition group ${isActive ? 'bg-blue-50 text-blue-600' : 'text-gray-600 hover:bg-gray-100'
    }`;
    ...
    <div className="h-16 bg-white border-b border-gray-200 sticky top-0 z-10 shadow-sm">
      <div className="h-full mx-auto px-6 flex items-center justify-between">
        ...
        >
          ...
          <h1 className="text-xl font-bold text-blue-600 hidden sm:block">Learn<span className="text-gray-900">Link</span></h1>
        </div>
